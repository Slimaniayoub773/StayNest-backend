...
<head>
    ...
    padding: 25px 20px 30px 20px; /* تم تقليل الطول */
    text-align: center;
    color: #fff;
    border-radius: 12px 12px 35px 35px / 12px 12px 20px 20px; /* انحناء أقل */
    position: relative;
    overflow: hidden;
}
        ...
        .circle {
            position: absolute;
            border-radius: 50%;
            border: 1px solid rgba(255, 255, 255, 0.15); /* حدود بيضاء شفافة */
            z-index: 1; /* خلف النص */
            pointer-events: none;
        }
...
.circle-3 {
    ...
    right: -40px;
        ...
        .circle-2 {
            ...
            top: 20px;
            left: 80px;
            background-color: rgba(255, 255, 255, 0.05); /* تعبئة خفيفة */
        }
        ...
        .header h1, .header p {
            position: relative;
            z-index: 10; /* لضمان ظهور النص فوق الدوائر */
        }
        ...
        .response-box-container {
            display: flex;
            background-color: #f3ecd9; /* لون البيج */
            border-radius: 8px;
            overflow: hidden;
            margin-bottom: 30px;
        ...
        .response-bar {
            background-color: #ba5022; /* الشريط الجانبي البرتقالي الغامق */
            width: 15px;
            min-width: 15px;
        }
        ...
        @media (max-width: 480px) {
            .header { padding: 30px 15px 40px 15px; }
